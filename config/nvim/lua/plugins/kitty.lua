return {
  {
    ...
    event = "VeryLazy",
    -- force loading as it seems not to lazy load appropriately
    lazy = false,
    keys = {
      {
        "<C-h>",
